...
export class RestaurantRealtimeGateway implements OnGatewayConnection, OnGatewayDisconnect {
  private readonly logger = new Logger(RestaurantRealtimeGateway.name);
  ...
  emit(hotelId: string, event: FnbRealtimeEvent) {
